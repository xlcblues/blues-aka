...
ERROR_CODE_HTTP_MAP = {
    ...
    ErrorCodes.Conversation.CONVERSATION_QUERY_FAILED: 500,
    ErrorCodes.Conversation.CONVERSATION_LIST_FAILED: 500,
    ErrorCodes.Conversation.CONVERSATION_CREATION_FAILED: 500,
    ErrorCodes.Conversation.CONVERSATION_UPDATE_FAILED: 500,
    ErrorCodes.Conversation.CONVERSATION_DELETE_FAILED: 500,
    ...
    ErrorCodes.Chat.FEEDBACK_FAILED: 500,
    ErrorCodes.Chat.NO_MESSAGE_TO_REGENERATE: 400,
    ErrorCodes.Chat.REGENERATE_FAILED: 500,
    ErrorCodes.Chat.STREAM_RESPONSE_FAILED: 500,
    ...
    ErrorCodes.RAG.DOCUMENT_NOT_FOUND: 404,
    ErrorCodes.RAG.DOCUMENT_UPLOAD_FAILED: 500,
    ErrorCodes.RAG.DOCUMENT_DELETE_FAILED: 500,
    ErrorCodes.RAG.INVALID_DOCUMENT_FORMAT: 400,
    ErrorCodes.RAG.DOCUMENT_TOO_LARGE: 413,
    ErrorCodes.RAG.DOCUMENT_ALREADY_EXISTS: 409,
    ErrorCodes.RAG.KNOWLEDGE_BASE_NOT_FOUND: 404,
    ErrorCodes.RAG.KNOWLEDGE_BASE_CREATION_FAILED: 500,
    ErrorCodes.RAG.KNOWLEDGE_BASE_UPDATE_FAILED: 500,
    ErrorCodes.RAG.KNOWLEDGE_BASE_DELETE_FAILED: 500,
    ErrorCodes.RAG.INDEX_CREATION_FAILED: 500,
    ErrorCodes.RAG.INDEX_UPDATE_FAILED: 500,
    ErrorCodes.RAG.INDEX_DELETE_FAILED: 500,
    ErrorCodes.RAG.INDEX_QUERY_FAILED: 500,
    ErrorCodes.RAG.RETRIEVAL_FAILED: 500,
...
ERROR_MESSAGE_TEMPLATES = {
    ...
    ErrorCodes.Conversation.CONVERSATION_QUERY_FAILED: "查询对话失败",
    ErrorCodes.Conversation.CONVERSATION_LIST_FAILED: "获取对话列表失败",
    ErrorCodes.Conversation.CONVERSATION_CREATION_FAILED: "对话创建失败",
    ErrorCodes.Conversation.CONVERSATION_UPDATE_FAILED: "对话更新失败",
    ErrorCodes.Conversation.CONVERSATION_DELETE_FAILED: "对话删除失败",
    ...
    ErrorCodes.Chat.FEEDBACK_FAILED: "反馈提交失败",
    ErrorCodes.Chat.NO_MESSAGE_TO_REGENERATE: "没有可重新生成的消息",
    ErrorCodes.Chat.REGENERATE_FAILED: "重新生成失败",
    ErrorCodes.Chat.STREAM_RESPONSE_FAILED: "流式响应失败",

    ErrorCodes.RAG.DOCUMENT_NOT_FOUND: "文档不存在",
    ErrorCodes.RAG.DOCUMENT_UPLOAD_FAILED: "文档上传失败",
    ErrorCodes.RAG.DOCUMENT_DELETE_FAILED: "文档删除失败",
    ErrorCodes.RAG.INVALID_DOCUMENT_FORMAT: "文档格式无效",
    ErrorCodes.RAG.DOCUMENT_TOO_LARGE: "文档过大",
    ErrorCodes.RAG.DOCUMENT_ALREADY_EXISTS: "文档已存在",
    ErrorCodes.RAG.KNOWLEDGE_BASE_NOT_FOUND: "知识库不存在",
    ErrorCodes.RAG.KNOWLEDGE_BASE_CREATION_FAILED: "知识库创建失败",
    ErrorCodes.RAG.KNOWLEDGE_BASE_UPDATE_FAILED: "知识库更新失败",
    ErrorCodes.RAG.KNOWLEDGE_BASE_DELETE_FAILED: "知识库删除失败",
    ErrorCodes.RAG.INDEX_CREATION_FAILED: "索引创建失败",
    ErrorCodes.RAG.INDEX_UPDATE_FAILED: "索引更新失败",
    ErrorCodes.RAG.INDEX_DELETE_FAILED: "索引删除失败",
    ErrorCodes.RAG.INDEX_QUERY_FAILED: "索引查询失败",
